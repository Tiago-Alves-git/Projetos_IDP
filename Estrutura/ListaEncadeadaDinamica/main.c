...
int main() {
    ...
    Lista* lista_fabrica_de_projetos2 = cria_lista();
    ...
    for(int i = 0; i < 10; i++) {
        ...
        insere_lista_ordenada(lista_fabrica_de_projetos2, fabrica_de_projetos2[i]);
    }

    combinar_listas(lista_estrutura_de_dados, lista_fabrica_de_projetos2, lista_combinada);
    printf("Lista Crescente:\n");
    consultar_lista(lista_combinada);

    inverter_lista(lista_combinada);
    printf("\nLista Decrescente:\n");
    consultar_lista(lista_combinada);

    libera_lista(lista_estrutura_de_dados);
    libera_lista(lista_fabrica_de_projetos2);
