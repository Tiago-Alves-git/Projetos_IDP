...
from utils.plotter import plot_market_trend, plot_top_players, plot_result_distribution, plot_attendance_trend, plot_home_away_performance, plot_game_summary
...
def main():
    ...
    # Análise de gols por jogador está dando erro por conta da coluna 'date' então resolvi tratar uma response que volte os dados com date e somente depois usar a funcao analyze
   ...
   # Plotar gráficos
    ...
    plot_game_summary(game_summary_data)  # Agora consumindo o dicionário retornado por game_summary
    plot_result_distribution(game_summary_data)  # Usando o dicionário de desempenho
    plot_home_away_performance(game_summary_data)  # Usando o dicionário de desempenho
    plot_attendance_trend(chelsea_games)


    # O resto está funcionando e assim que terminar de funcionar iremos plotar os gráficos.
